@props(['id'])
<div class="inline-flex items-center" wire:loading.remove wire:target="hapus('{{ $id }}')"
    x-data="{ 'showModal': false }" @keydown.escape="showModal = false" @keydown.enter="$wire.hapus('{{ $id }}')">
    <!-- Trigger for Modal -->
            ...
            <div class="py-5">
                ...
                <div class="flex space-x-3">
                    <button type="button"
                        ...
                        @click="$wire.hapus('{{ $id }}'), showModal = false">
                        Ya, Hapus
                    </button>
                    <button type="button"
