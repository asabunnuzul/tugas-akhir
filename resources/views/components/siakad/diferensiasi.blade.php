@props(['label' => 'diferensiasi', 'disabled' => false])
<div class="flex flex-col space-y-1 capitalize text-md text-slate-600">
    ...
    <select
        ...
        <option value="">Pilih Diferensiasi</option>
        <option value="1">DF 1</option>
        <option value="2">DF 2</option>
        <option value="3">DF 3</option>
    </select>
